...
6. 参考資料 44Docker 公式ドキュメント: https://docs.docker.com/ 45Apache HTTP Server 公式ドキュメント: https://httpd.apache.org/ 46MySQL Docker Hub ページ: https://hub.docker.com/_/mysql 47Ubuntu UFW マニュアル: https://help.ubuntu.com/community/UFW 48